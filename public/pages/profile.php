    ...
    <div class="page-wrapper">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a class="nav-link" href="incidents.php">Incident Monitoring</a>                <a class="nav-link" href="device_incidents.php">Device Tracking</a>                <a class="nav-link" href="alerts.php">Alert Records</a>
